...
5. **Supporting Layers**
   ...
   - `/ai` — AI augmentation (placeholder for future LLM workflows)
...
- `ai_annotation`, `vector_store`, `document`
...
- AI enrichment: controlled LLM augmentation (RAG, schema verification, provenance)
